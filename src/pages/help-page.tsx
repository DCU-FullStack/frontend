              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">사고 관리</h4>
                      <p className="text-sm text-muted-foreground">
                        발생한 사고를 등록하고 관리하며, 상태를 업데이트할 수 있습니다.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">작업 관리</h4>
                      <p className="text-sm text-muted-foreground">
                        사고 대응을 위한 작업을 할당하고 진행 상황을 추적할 수 있습니다.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">CCTV 모니터링</h4>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">사용자 관리</h4>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">1. 로그인</h4>
                      <p className="text-sm text-muted-foreground">
                        관리자가 제공한 계정 정보로 시스템에 로그인합니다.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">2. 대시보드 확인</h4>
                      <p className="text-sm text-muted-foreground">
                        대시보드에서 시스템의 전반적인 상태와 중요 정보를 확인합니다.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">3. 사고 관리</h4>
                      <p className="text-sm text-muted-foreground">
                        사고 관리 페이지에서 발생한 사고를 확인하고 상태를 업데이트합니다.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">4. 작업 할당</h4>
                      <p className="text-sm text-muted-foreground">
                        작업 관리 페이지에서 사고 대응을 위한 작업을 할당하고 진행 상황을 추적합니다.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-2">5. CCTV 모니터링</h4>
                      <p className="text-sm text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <a href="#" className="text-primary hover:underline flex items-center">
                          사용자 매뉴얼 <ExternalLink className="h-4 w-4 ml-1" />
                        </a>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Book className="h-5 w-5 text-primary" />
                        <a href="#" className="text-primary hover:underline flex items-center">
                          API 문서 <ExternalLink className="h-4 w-4 ml-1" />
                        </a>
                      </div>
                      <div className="flex items-center space-x-2">
                        <HelpCircle className="h-5 w-5 text-primary" />
                        <a href="#" className="text-primary hover:underline flex items-center">
                          문제 해결 가이드 <ExternalLink className="h-4 w-4 ml-1" />
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 border rounded-lg bg-muted/50">
                  <h3 className="font-medium mb-2">문의 양식</h3>
